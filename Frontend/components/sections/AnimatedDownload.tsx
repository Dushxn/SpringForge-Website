...
const INSTALL_STEPS = [
  <>Download the <code className="rounded bg-dark-hover px-1.5 py-0.5 text-accent">.zip</code> file above</>,
  <>Open IntelliJ IDEA → <code className="rounded bg-dark-hover px-1.5 py-0.5 text-content-primary">Settings</code> → <code className="rounded bg-dark-hover px-1.5 py-0.5 text-content-primary">Plugins</code></>,
  <>Click ⚙ gear icon → <code className="rounded bg-dark-hover px-1.5 py-0.5 text-content-primary">Install Plugin from Disk…</code></>,
  <>Select the downloaded <code className="rounded bg-dark-hover px-1.5 py-0.5 text-accent">.zip</code> and restart IntelliJ IDEA</>,
]
    ...
    >
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mb-8 text-content-secondary">
          Install via{' '}
          <span className="text-content-primary">Settings → Plugins → Install from Disk</span>
          {' '}in IntelliJ IDEA
        </p>
          ...
          {plugin.hasFile ? (
            ...
            >
              <motion.a
                ...
                download
                style={{ x: btnX, y: btnY }}
                className="inline-flex items-center gap-2 rounded-xl bg-accent px-8 py-4 text-lg font-semibold text-black transition hover:bg-accent-dark hover:shadow-[0_0_40px_rgba(0,255,170,0.25)]"
